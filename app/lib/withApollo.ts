...
// export var globalApolloClient = null;
//
// /**
...
//
//   if (ctx.req.headers) {
//     // Assume we are fetching a merchant store and return the website for SSR.
//     let hostname = ctx.req.headers.host;
//
//     headers["x-hasura-origin"] = hostname;
//   }
//
//   return headers;
// }
...
//  */
// export const initApolloClient = (initialState, headers) => {
...
//             // TODO Peter Investigate why this was originally there.
//             // Head.rewind()
//           }
//         }
//
