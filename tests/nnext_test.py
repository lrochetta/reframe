...
from nnext.http.models import Filter, FieldCondition, Range, PointStruct, HasIdCondition, PointIdsList, \
    PayloadSchemaType, MatchValue, Distance, CreateAliasOperation, CreateAlias, OptimizersConfigDiff
from nnext.uploader.grpc_uploader import payload_to_grpc
...
def test_serialization():
    from nnext.grpc import PointStruct as PointStructGrpc
    from nnext.grpc import PointId as PointIdGrpc
