...
from nnext.server.lib.db_connection import Database
from nnext.server.lib.db_models.namespace import Namespace, Job
...
def protected_route(request: Request, namespace: Annotated[Namespace, Depends(get_api_key)], api_key: str = Security(get_api_key)):
